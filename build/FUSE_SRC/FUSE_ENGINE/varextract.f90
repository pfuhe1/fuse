...
SELECT CASE (TRIM(VARNAME))
 ...
 CASE ('swe_z01')    ; XVAR_3d = MBANDS_VAR_4d(:,:,1,:)%SWE
 CASE ('swe_z02')    ; XVAR_3d = MBANDS_VAR_4d(:,:,2,:)%SWE
 CASE ('swe_z03')    ; XVAR_3d = MBANDS_VAR_4d(:,:,3,:)%SWE
 CASE ('swe_z04')    ; XVAR_3d = MBANDS_VAR_4d(:,:,4,:)%SWE
 CASE ('swe_z05')    ; XVAR_3d = MBANDS_VAR_4d(:,:,5,:)%SWE
 CASE ('swe_z06')    ; XVAR_3d = MBANDS_VAR_4d(:,:,6,:)%SWE
 CASE ('swe_z07')    ; XVAR_3d = MBANDS_VAR_4d(:,:,7,:)%SWE
 CASE ('swe_z08')    ; XVAR_3d = MBANDS_VAR_4d(:,:,8,:)%SWE
 CASE ('swe_z09')    ; XVAR_3d = MBANDS_VAR_4d(:,:,9,:)%SWE
 CASE ('swe_z10')    ; XVAR_3d = MBANDS_VAR_4d(:,:,10,:)%SWE
 CASE ('swe_z11')    ; XVAR_3d = MBANDS_VAR_4d(:,:,11,:)%SWE
 CASE ('swe_z12')    ; XVAR_3d = MBANDS_VAR_4d(:,:,12,:)%SWE
 CASE ('swe_z13')    ; XVAR_3d = MBANDS_VAR_4d(:,:,13,:)%SWE
 CASE ('swe_z14')    ; XVAR_3d = MBANDS_VAR_4d(:,:,14,:)%SWE
 CASE ('swe_z15')    ; XVAR_3d = MBANDS_VAR_4d(:,:,15,:)%SWE
 CASE ('swe_z16')    ; XVAR_3d = MBANDS_VAR_4d(:,:,16,:)%SWE
 CASE ('swe_z17')    ; XVAR_3d = MBANDS_VAR_4d(:,:,17,:)%SWE
 CASE ('swe_z18')    ; XVAR_3d = MBANDS_VAR_4d(:,:,18,:)%SWE
 CASE ('swe_z19')    ; XVAR_3d = MBANDS_VAR_4d(:,:,19,:)%SWE
 CASE ('swe_z20')    ; XVAR_3d = MBANDS_VAR_4d(:,:,20,:)%SWE
 CASE ('swe_z21')    ; XVAR_3d = MBANDS_VAR_4d(:,:,21,:)%SWE
 CASE ('swe_z22')    ; XVAR_3d = MBANDS_VAR_4d(:,:,22,:)%SWE
 CASE ('swe_z23')    ; XVAR_3d = MBANDS_VAR_4d(:,:,23,:)%SWE
 CASE ('swe_z24')    ; XVAR_3d = MBANDS_VAR_4d(:,:,24,:)%SWE
 CASE ('swe_z25')    ; XVAR_3d = MBANDS_VAR_4d(:,:,25,:)%SWE
 CASE ('swe_z26')    ; XVAR_3d = MBANDS_VAR_4d(:,:,26,:)%SWE
 CASE ('swe_z27')    ; XVAR_3d = MBANDS_VAR_4d(:,:,27,:)%SWE
 CASE ('swe_z28')    ; XVAR_3d = MBANDS_VAR_4d(:,:,28,:)%SWE
 CASE ('swe_z29')    ; XVAR_3d = MBANDS_VAR_4d(:,:,29,:)%SWE
 CASE ('swe_z30')    ; XVAR_3d = MBANDS_VAR_4d(:,:,30,:)%SWE
 CASE ('swe_z31')    ; XVAR_3d = MBANDS_VAR_4d(:,:,31,:)%SWE
 CASE ('swe_z32')    ; XVAR_3d = MBANDS_VAR_4d(:,:,32,:)%SWE
 CASE ('swe_z33')    ; XVAR_3d = MBANDS_VAR_4d(:,:,33,:)%SWE
 CASE ('swe_z34')    ; XVAR_3d = MBANDS_VAR_4d(:,:,34,:)%SWE
 CASE ('swe_z35')    ; XVAR_3d = MBANDS_VAR_4d(:,:,35,:)%SWE
 CASE ('swe_z36')    ; XVAR_3d = MBANDS_VAR_4d(:,:,36,:)%SWE
 CASE ('swe_z37')    ; XVAR_3d = MBANDS_VAR_4d(:,:,37,:)%SWE
 CASE ('swe_z38')    ; XVAR_3d = MBANDS_VAR_4d(:,:,38,:)%SWE
 CASE ('swe_z39')    ; XVAR_3d = MBANDS_VAR_4d(:,:,39,:)%SWE
 CASE ('swe_z40')    ; XVAR_3d = MBANDS_VAR_4d(:,:,40,:)%SWE
 CASE ('swe_z41')    ; XVAR_3d = MBANDS_VAR_4d(:,:,41,:)%SWE
 CASE ('swe_z42')    ; XVAR_3d = MBANDS_VAR_4d(:,:,42,:)%SWE
 CASE ('swe_z43')    ; XVAR_3d = MBANDS_VAR_4d(:,:,43,:)%SWE
 CASE ('swe_z44')    ; XVAR_3d = MBANDS_VAR_4d(:,:,44,:)%SWE
 CASE ('swe_z45')    ; XVAR_3d = MBANDS_VAR_4d(:,:,45,:)%SWE
 CASE ('swe_z46')    ; XVAR_3d = MBANDS_VAR_4d(:,:,46,:)%SWE
 CASE ('swe_z47')    ; XVAR_3d = MBANDS_VAR_4d(:,:,47,:)%SWE
 CASE ('swe_z48')    ; XVAR_3d = MBANDS_VAR_4d(:,:,48,:)%SWE
 CASE ('swe_z49')    ; XVAR_3d = MBANDS_VAR_4d(:,:,49,:)%SWE
 CASE ('swe_z50')    ; XVAR_3d = MBANDS_VAR_4d(:,:,50,:)%SWE
 ! extract model fluxes
 ...
 CASE ('snwmelt')    ; XVAR_3d = W_FLUX_3d%SNWMELT
 CASE ('snwacml_z01'); XVAR_3d = MBANDS_VAR_4d(:,:,1,:)%SNOWACCMLTN
 CASE ('snwacml_z02'); XVAR_3d = MBANDS_VAR_4d(:,:,2,:)%SNOWACCMLTN
 CASE ('snwacml_z03'); XVAR_3d = MBANDS_VAR_4d(:,:,3,:)%SNOWACCMLTN
 CASE ('snwacml_z04'); XVAR_3d = MBANDS_VAR_4d(:,:,4,:)%SNOWACCMLTN
 CASE ('snwacml_z05'); XVAR_3d = MBANDS_VAR_4d(:,:,5,:)%SNOWACCMLTN
 CASE ('snwacml_z06'); XVAR_3d = MBANDS_VAR_4d(:,:,6,:)%SNOWACCMLTN
 CASE ('snwacml_z07'); XVAR_3d = MBANDS_VAR_4d(:,:,7,:)%SNOWACCMLTN
 CASE ('snwacml_z08'); XVAR_3d = MBANDS_VAR_4d(:,:,8,:)%SNOWACCMLTN
 CASE ('snwacml_z09'); XVAR_3d = MBANDS_VAR_4d(:,:,9,:)%SNOWACCMLTN
 CASE ('snwacml_z10'); XVAR_3d = MBANDS_VAR_4d(:,:,10,:)%SNOWACCMLTN
 CASE ('snwacml_z11'); XVAR_3d = MBANDS_VAR_4d(:,:,11,:)%SNOWACCMLTN
 CASE ('snwacml_z12'); XVAR_3d = MBANDS_VAR_4d(:,:,12,:)%SNOWACCMLTN
 CASE ('snwacml_z13'); XVAR_3d = MBANDS_VAR_4d(:,:,13,:)%SNOWACCMLTN
 CASE ('snwacml_z14'); XVAR_3d = MBANDS_VAR_4d(:,:,14,:)%SNOWACCMLTN
 CASE ('snwacml_z15'); XVAR_3d = MBANDS_VAR_4d(:,:,15,:)%SNOWACCMLTN
 CASE ('snwacml_z16'); XVAR_3d = MBANDS_VAR_4d(:,:,16,:)%SNOWACCMLTN
 CASE ('snwacml_z17'); XVAR_3d = MBANDS_VAR_4d(:,:,17,:)%SNOWACCMLTN
 CASE ('snwacml_z18'); XVAR_3d = MBANDS_VAR_4d(:,:,18,:)%SNOWACCMLTN
 CASE ('snwacml_z19'); XVAR_3d = MBANDS_VAR_4d(:,:,19,:)%SNOWACCMLTN
 CASE ('snwacml_z20'); XVAR_3d = MBANDS_VAR_4d(:,:,20,:)%SNOWACCMLTN
 CASE ('snwacml_z21'); XVAR_3d = MBANDS_VAR_4d(:,:,21,:)%SNOWACCMLTN
 CASE ('snwacml_z22'); XVAR_3d = MBANDS_VAR_4d(:,:,22,:)%SNOWACCMLTN
 CASE ('snwacml_z23'); XVAR_3d = MBANDS_VAR_4d(:,:,23,:)%SNOWACCMLTN
 CASE ('snwacml_z24'); XVAR_3d = MBANDS_VAR_4d(:,:,24,:)%SNOWACCMLTN
 CASE ('snwacml_z25'); XVAR_3d = MBANDS_VAR_4d(:,:,25,:)%SNOWACCMLTN
 CASE ('snwacml_z26'); XVAR_3d = MBANDS_VAR_4d(:,:,26,:)%SNOWACCMLTN
 CASE ('snwacml_z27'); XVAR_3d = MBANDS_VAR_4d(:,:,27,:)%SNOWACCMLTN
 CASE ('snwacml_z28'); XVAR_3d = MBANDS_VAR_4d(:,:,28,:)%SNOWACCMLTN
 CASE ('snwacml_z29'); XVAR_3d = MBANDS_VAR_4d(:,:,29,:)%SNOWACCMLTN
 CASE ('snwacml_z30'); XVAR_3d = MBANDS_VAR_4d(:,:,30,:)%SNOWACCMLTN
 CASE ('snwacml_z31'); XVAR_3d = MBANDS_VAR_4d(:,:,31,:)%SNOWACCMLTN
 CASE ('snwacml_z32'); XVAR_3d = MBANDS_VAR_4d(:,:,32,:)%SNOWACCMLTN
 CASE ('snwacml_z33'); XVAR_3d = MBANDS_VAR_4d(:,:,33,:)%SNOWACCMLTN
 CASE ('snwacml_z34'); XVAR_3d = MBANDS_VAR_4d(:,:,34,:)%SNOWACCMLTN
 CASE ('snwacml_z35'); XVAR_3d = MBANDS_VAR_4d(:,:,35,:)%SNOWACCMLTN
 CASE ('snwacml_z36'); XVAR_3d = MBANDS_VAR_4d(:,:,36,:)%SNOWACCMLTN
 CASE ('snwacml_z37'); XVAR_3d = MBANDS_VAR_4d(:,:,37,:)%SNOWACCMLTN
 CASE ('snwacml_z38'); XVAR_3d = MBANDS_VAR_4d(:,:,38,:)%SNOWACCMLTN
 CASE ('snwacml_z39'); XVAR_3d = MBANDS_VAR_4d(:,:,39,:)%SNOWACCMLTN
 CASE ('snwacml_z40'); XVAR_3d = MBANDS_VAR_4d(:,:,40,:)%SNOWACCMLTN
 CASE ('snwacml_z41'); XVAR_3d = MBANDS_VAR_4d(:,:,41,:)%SNOWACCMLTN
 CASE ('snwacml_z42'); XVAR_3d = MBANDS_VAR_4d(:,:,42,:)%SNOWACCMLTN
 CASE ('snwacml_z43'); XVAR_3d = MBANDS_VAR_4d(:,:,43,:)%SNOWACCMLTN
 CASE ('snwacml_z44'); XVAR_3d = MBANDS_VAR_4d(:,:,44,:)%SNOWACCMLTN
 CASE ('snwacml_z45'); XVAR_3d = MBANDS_VAR_4d(:,:,45,:)%SNOWACCMLTN
 CASE ('snwacml_z46'); XVAR_3d = MBANDS_VAR_4d(:,:,46,:)%SNOWACCMLTN
 CASE ('snwacml_z47'); XVAR_3d = MBANDS_VAR_4d(:,:,47,:)%SNOWACCMLTN
 CASE ('snwacml_z48'); XVAR_3d = MBANDS_VAR_4d(:,:,48,:)%SNOWACCMLTN
 CASE ('snwacml_z49'); XVAR_3d = MBANDS_VAR_4d(:,:,49,:)%SNOWACCMLTN
 CASE ('snwacml_z50'); XVAR_3d = MBANDS_VAR_4d(:,:,50,:)%SNOWACCMLTN
 CASE ('snwmelt_z01'); XVAR_3d = MBANDS_VAR_4d(:,:,1,:)%SNOWMELT
 CASE ('snwmelt_z02'); XVAR_3d = MBANDS_VAR_4d(:,:,2,:)%SNOWMELT
 CASE ('snwmelt_z03'); XVAR_3d = MBANDS_VAR_4d(:,:,3,:)%SNOWMELT
 CASE ('snwmelt_z04'); XVAR_3d = MBANDS_VAR_4d(:,:,4,:)%SNOWMELT
 CASE ('snwmelt_z05'); XVAR_3d = MBANDS_VAR_4d(:,:,5,:)%SNOWMELT
 CASE ('snwmelt_z06'); XVAR_3d = MBANDS_VAR_4d(:,:,6,:)%SNOWMELT
 CASE ('snwmelt_z07'); XVAR_3d = MBANDS_VAR_4d(:,:,7,:)%SNOWMELT
 CASE ('snwmelt_z08'); XVAR_3d = MBANDS_VAR_4d(:,:,8,:)%SNOWMELT
 CASE ('snwmelt_z09'); XVAR_3d = MBANDS_VAR_4d(:,:,9,:)%SNOWMELT
 CASE ('snwmelt_z10'); XVAR_3d = MBANDS_VAR_4d(:,:,10,:)%SNOWMELT
 CASE ('snwmelt_z11'); XVAR_3d = MBANDS_VAR_4d(:,:,11,:)%SNOWMELT
 CASE ('snwmelt_z12'); XVAR_3d = MBANDS_VAR_4d(:,:,12,:)%SNOWMELT
 CASE ('snwmelt_z13'); XVAR_3d = MBANDS_VAR_4d(:,:,13,:)%SNOWMELT
 CASE ('snwmelt_z14'); XVAR_3d = MBANDS_VAR_4d(:,:,14,:)%SNOWMELT
 CASE ('snwmelt_z15'); XVAR_3d = MBANDS_VAR_4d(:,:,15,:)%SNOWMELT
 CASE ('snwmelt_z16'); XVAR_3d = MBANDS_VAR_4d(:,:,16,:)%SNOWMELT
 CASE ('snwmelt_z17'); XVAR_3d = MBANDS_VAR_4d(:,:,17,:)%SNOWMELT
 CASE ('snwmelt_z18'); XVAR_3d = MBANDS_VAR_4d(:,:,18,:)%SNOWMELT
 CASE ('snwmelt_z19'); XVAR_3d = MBANDS_VAR_4d(:,:,19,:)%SNOWMELT
 CASE ('snwmelt_z20'); XVAR_3d = MBANDS_VAR_4d(:,:,20,:)%SNOWMELT
 CASE ('snwmelt_z21'); XVAR_3d = MBANDS_VAR_4d(:,:,21,:)%SNOWMELT
 CASE ('snwmelt_z22'); XVAR_3d = MBANDS_VAR_4d(:,:,22,:)%SNOWMELT
 CASE ('snwmelt_z23'); XVAR_3d = MBANDS_VAR_4d(:,:,23,:)%SNOWMELT
 CASE ('snwmelt_z24'); XVAR_3d = MBANDS_VAR_4d(:,:,24,:)%SNOWMELT
 CASE ('snwmelt_z25'); XVAR_3d = MBANDS_VAR_4d(:,:,25,:)%SNOWMELT
 CASE ('snwmelt_z26'); XVAR_3d = MBANDS_VAR_4d(:,:,26,:)%SNOWMELT
 CASE ('snwmelt_z27'); XVAR_3d = MBANDS_VAR_4d(:,:,27,:)%SNOWMELT
 CASE ('snwmelt_z28'); XVAR_3d = MBANDS_VAR_4d(:,:,28,:)%SNOWMELT
 CASE ('snwmelt_z29'); XVAR_3d = MBANDS_VAR_4d(:,:,29,:)%SNOWMELT
 CASE ('snwmelt_z30'); XVAR_3d = MBANDS_VAR_4d(:,:,30,:)%SNOWMELT
 CASE ('snwmelt_z31'); XVAR_3d = MBANDS_VAR_4d(:,:,31,:)%SNOWMELT
 CASE ('snwmelt_z32'); XVAR_3d = MBANDS_VAR_4d(:,:,32,:)%SNOWMELT
 CASE ('snwmelt_z33'); XVAR_3d = MBANDS_VAR_4d(:,:,33,:)%SNOWMELT
 CASE ('snwmelt_z34'); XVAR_3d = MBANDS_VAR_4d(:,:,34,:)%SNOWMELT
 CASE ('snwmelt_z35'); XVAR_3d = MBANDS_VAR_4d(:,:,35,:)%SNOWMELT
 CASE ('snwmelt_z36'); XVAR_3d = MBANDS_VAR_4d(:,:,36,:)%SNOWMELT
 CASE ('snwmelt_z37'); XVAR_3d = MBANDS_VAR_4d(:,:,37,:)%SNOWMELT
 CASE ('snwmelt_z38'); XVAR_3d = MBANDS_VAR_4d(:,:,38,:)%SNOWMELT
 CASE ('snwmelt_z39'); XVAR_3d = MBANDS_VAR_4d(:,:,39,:)%SNOWMELT
 CASE ('snwmelt_z40'); XVAR_3d = MBANDS_VAR_4d(:,:,40,:)%SNOWMELT
 CASE ('snwmelt_z41'); XVAR_3d = MBANDS_VAR_4d(:,:,41,:)%SNOWMELT
 CASE ('snwmelt_z42'); XVAR_3d = MBANDS_VAR_4d(:,:,42,:)%SNOWMELT
 CASE ('snwmelt_z43'); XVAR_3d = MBANDS_VAR_4d(:,:,43,:)%SNOWMELT
 CASE ('snwmelt_z44'); XVAR_3d = MBANDS_VAR_4d(:,:,44,:)%SNOWMELT
 CASE ('snwmelt_z45'); XVAR_3d = MBANDS_VAR_4d(:,:,45,:)%SNOWMELT
 CASE ('snwmelt_z46'); XVAR_3d = MBANDS_VAR_4d(:,:,46,:)%SNOWMELT
 CASE ('snwmelt_z47'); XVAR_3d = MBANDS_VAR_4d(:,:,47,:)%SNOWMELT
 CASE ('snwmelt_z48'); XVAR_3d = MBANDS_VAR_4d(:,:,48,:)%SNOWMELT
 CASE ('snwmelt_z49'); XVAR_3d = MBANDS_VAR_4d(:,:,49,:)%SNOWMELT
 CASE ('snwmelt_z50'); XVAR_3d = MBANDS_VAR_4d(:,:,50,:)%SNOWMELT
 ! extract extrapolation errors
